...
module TheBlairs
  ...
  class Gift
    ...
    def self.all
      ...
      gifts << Gift.new("Premium flight upgrade", "How amazing would it be if we could start our journey in total luxuary by upgrading our flights?  We would really enjoy sniggering at the plebs in the back of the plane while supping on champagne, that's for sure!", 200)
      ...
      gifts << Gift.new("Trip to the turtle rescue project", "The beaches of Costa Rica are the nesting grounds of thousands of turtles, which are under threat from egg poaching.  It would be fantastic to visit the sea turtle rescue project and see the wonderful work they do.", 35)
